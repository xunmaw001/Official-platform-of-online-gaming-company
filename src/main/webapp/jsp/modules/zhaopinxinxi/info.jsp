						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="zhaopinbianhao" name="zhaopinbianhao" class="form-control" v-model="ruleForm.zhaopinbianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>公司名称</label>

									<input id="gongsimingcheng" name="gongsimingcheng" class="form-control" v-model="ruleForm.gongsimingcheng" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>招聘岗位</label>

									<input id="zhaopingangwei" name="zhaopingangwei" class="form-control" v-model="ruleForm.zhaopingangwei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>招聘人数</label>
	...
	<script>
		...
		function setContent(){
			...
			if(ruleForm.gongzidaiyu != null && ruleForm.gongzidaiyu != 'null' && ruleForm.gongzidaiyu != ''){
				var mes = '' + ruleForm.gongzidaiyu;
				var gongzidaiyuUeditor = UE.getEditor('gongzidaiyuEditor');
				gongzidaiyuUeditor.ready(function() {
					gongzidaiyuUeditor.setContent(mes);
					gongzidaiyuUeditor.setDisabled('fullscreen');
				});
			}
		}  
