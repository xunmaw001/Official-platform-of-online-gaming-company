...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>公司名称</label>
										<input id="gongsimingcheng" name="gongsimingcheng" class="form-control" placeholder="公司名称">
									</div>
									<div class="form-group col-md-6">
										<label>招聘岗位</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#gongsimingcheng").val(ruleForm.gongsimingcheng);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gongsimingcheng != null && res.data.gongsimingcheng != ''){

					$("#gongsimingcheng").val(res.data.gongsimingcheng);
					}
