				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>游戏下载：</span>
							<span class="desc">
								<a download="youxixiazai" :href="detail.youxixiazai">点击下载</a>
							</span>
						</div>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.youxijianjie"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`youxizhongxin`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.youximingcheng;
																																								// 轮播图片
					vue.swiperList = vue.detail.youxihaibao ? vue.detail.youxihaibao.split(",") : [];
																																																																											var swiperItemHtml = '';
