				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>招聘编号：</span>
							<span class="desc">
								{{detail.zhaopinbianhao}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>招聘岗位：</span>
							<span class="desc">
								{{detail.zhaopingangwei}}
							</span>
						</div>
																								<div class="detail-item">
							<span>招聘人数：</span>
							<span class="desc">
								{{detail.zhaopinrenshu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>联系方式：</span>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.zhiweiyaoqiu"></div>
							</div>
																																										<div class="layui-tab-item">
								<div v-html="detail.gongzidaiyu"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`zhaopinxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.gongsimingcheng;
																																																												// 轮播图片
