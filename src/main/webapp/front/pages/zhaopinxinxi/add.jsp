			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.zhaopinbianhao" type="text" name="zhaopinbianhao" id="zhaopinbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">公司名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.gongsimingcheng" type="text" name="gongsimingcheng" id="gongsimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">招聘岗位：</label>
						<div class="layui-input-block">
							<input v-model="detail.zhaopingangwei" type="text" name="zhaopingangwei" id="zhaopingangwei" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="zhiweiyaoqiu" id="zhiweiyaoqiu">请输入职位要求</textarea>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">工资待遇：</label>
						<div class="layui-input-block">
							<textarea name="gongzidaiyu" id="gongzidaiyu">请输入工资待遇</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var zhiweiyaoqiu = tinymce.get('#zhiweiyaoqiu').getContent()
					data.zhiweiyaoqiu = zhiweiyaoqiu;
										                                                                                                                                                                					var gongzidaiyu = tinymce.get('#gongzidaiyu').getContent()
					data.gongzidaiyu = gongzidaiyu;
